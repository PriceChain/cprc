...
type GenesisState struct {
	...
	PriceConsensusList  []PriceConsensus `protobuf:"bytes,8,rep,name=priceConsensusList,proto3" json:"priceConsensusList"`
	PriceConsensusCount uint64           `protobuf:"varint,9,opt,name=priceConsensusCount,proto3" json:"priceConsensusCount,omitempty"`
}
...
func (m *GenesisState) GetPriceConsensusList() []PriceConsensus {
	if m != nil {
		return m.PriceConsensusList
	}
	return nil
}

func (m *GenesisState) GetPriceConsensusCount() uint64 {
	if m != nil {
		return m.PriceConsensusCount
	}
	return 0
}
...
var fileDescriptor_ed2e112cbf381ddc = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PriceConsensusCount != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.PriceConsensusCount))
		i--
		dAtA[i] = 0x48
	}
	if len(m.PriceConsensusList) > 0 {
		for iNdEx := len(m.PriceConsensusList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PriceConsensusList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.PriceConsensusList) > 0 {
		for _, e := range m.PriceConsensusList {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
	if m.PriceConsensusCount != 0 {
		n += 1 + sovGenesis(uint64(m.PriceConsensusCount))
	}
	return n
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PriceConsensusList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PriceConsensusList = append(m.PriceConsensusList, PriceConsensus{})
			if err := m.PriceConsensusList[len(m.PriceConsensusList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PriceConsensusCount", wireType)
			}
			m.PriceConsensusCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGenesis
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PriceConsensusCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
