...
const baseRegistryStakedAmountPerWallet: object = {
  index: "",
  wallet: "",
  stakedAmount: "",
};

export const RegistryStakedAmountPerWallet = {
  encode(
  ...
  decode(
    ...
    const message = {
      ...baseRegistryStakedAmountPerWallet,
    } as RegistryStakedAmountPerWallet;
  ...
  fromJSON(object: any): RegistryStakedAmountPerWallet {
    const message = {
      ...baseRegistryStakedAmountPerWallet,
    } as RegistryStakedAmountPerWallet;
  ...
  toJSON(message: RegistryStakedAmountPerWallet): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<RegistryStakedAmountPerWallet>
  ): RegistryStakedAmountPerWallet {
    const message = {
      ...baseRegistryStakedAmountPerWallet,
    } as RegistryStakedAmountPerWallet;
