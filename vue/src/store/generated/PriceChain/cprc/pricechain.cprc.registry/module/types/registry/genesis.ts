...
export const GenesisState = {
  encode(message: GenesisState, writer: Writer = Writer.create()): Writer {
    ...
    for (const v of message.registryStakedAmountPerWalletList) {
  ...
  decode(input: Reader | Uint8Array, length?: number): GenesisState {
    ...
    message.registryStakedAmountPerWalletList = [];
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          break;
        case 9:
          message.registryStakedAmountPerWalletList.push(
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (
      object.registryStakedAmountPerWalletList !== undefined &&
      object.registryStakedAmountPerWalletList !== null
    ) {
      for (const e of object.registryStakedAmountPerWalletList) {
        message.registryStakedAmountPerWalletList.push(
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.registryStakedAmountPerWalletList) {
      obj.registryStakedAmountPerWalletList = message.registryStakedAmountPerWalletList.map(
        (e) => (e ? RegistryStakedAmountPerWallet.toJSON(e) : undefined)
      );
    } else {
      obj.registryStakedAmountPerWalletList = [];
    }
