...
const baseMsgWithdrawRewards: object = {
  creator: "",
  amount: "",
  registryId: "",
};
...
export const MsgWithdrawRewards = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgWithdrawRewards {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgWithdrawRewards } as MsgWithdrawRewards;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: DeepPartial<MsgWithdrawRewards>): MsgWithdrawRewards {
    const message = { ...baseMsgWithdrawRewards } as MsgWithdrawRewards;
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = object.creator;
    } else {
...
const baseMsgWithdrawRewardsResponse: object = {};
...
export const MsgWithdrawRewardsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgWithdrawRewardsResponse,
  ...
  fromPartial(
    _: DeepPartial<MsgWithdrawRewardsResponse>
  ): MsgWithdrawRewardsResponse {
    const message = {
      ...baseMsgWithdrawRewardsResponse,
    } as MsgWithdrawRewardsResponse;
...
export class MsgClientImpl implements Msg {
  ...
  WithdrawRewards(
    ...
    return promise.then((data) =>
      MsgWithdrawRewardsResponse.decode(new Reader(data))
    );
  }
}
