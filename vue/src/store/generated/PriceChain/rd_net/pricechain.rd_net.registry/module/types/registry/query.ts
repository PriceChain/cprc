...
export interface QueryGetPriceConsensusRequest {
  id: number;
}

export interface QueryGetPriceConsensusResponse {
  PriceConsensus: PriceConsensus | undefined;
}

export interface QueryAllPriceConsensusRequest {
  pagination: PageRequest | undefined;
}

export interface QueryAllPriceConsensusResponse {
...
const baseQueryGetPriceConsensusRequest: object = { id: 0 };

export const QueryGetPriceConsensusRequest = {
  encode(
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetPriceConsensusRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetPriceConsensusRequest,
    } as QueryGetPriceConsensusRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetPriceConsensusRequest {
    const message = {
      ...baseQueryGetPriceConsensusRequest,
    } as QueryGetPriceConsensusRequest;
    if (object.id !== undefined && object.id !== null) {
  ...
  toJSON(message: QueryGetPriceConsensusRequest): unknown {
    const obj: any = {};
    message.id !== undefined && (obj.id = message.id);
    return obj;
  },
  ...
  fromPartial(
    object: DeepPartial<QueryGetPriceConsensusRequest>
  ): QueryGetPriceConsensusRequest {
    const message = {
      ...baseQueryGetPriceConsensusRequest,
    } as QueryGetPriceConsensusRequest;
...
const baseQueryGetPriceConsensusResponse: object = {};

export const QueryGetPriceConsensusResponse = {
  encode(
    message: QueryGetPriceConsensusResponse,
    writer: Writer = Writer.create()
  ): Writer {
    if (message.PriceConsensus !== undefined) {
      PriceConsensus.encode(
        message.PriceConsensus,
        writer.uint32(10).fork()
      ).ldelim();
    }
    return writer;
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetPriceConsensusResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetPriceConsensusResponse,
    } as QueryGetPriceConsensusResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.PriceConsensus = PriceConsensus.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): QueryGetPriceConsensusResponse {
    const message = {
      ...baseQueryGetPriceConsensusResponse,
    } as QueryGetPriceConsensusResponse;
    if (object.PriceConsensus !== undefined && object.PriceConsensus !== null) {
      message.PriceConsensus = PriceConsensus.fromJSON(object.PriceConsensus);
    } else {
      message.PriceConsensus = undefined;
    }
    return message;
  },

  toJSON(message: QueryGetPriceConsensusResponse): unknown {
    const obj: any = {};
    message.PriceConsensus !== undefined &&
      (obj.PriceConsensus = message.PriceConsensus
        ? PriceConsensus.toJSON(message.PriceConsensus)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetPriceConsensusResponse>
  ): QueryGetPriceConsensusResponse {
    const message = {
      ...baseQueryGetPriceConsensusResponse,
    } as QueryGetPriceConsensusResponse;
    if (object.PriceConsensus !== undefined && object.PriceConsensus !== null) {
      message.PriceConsensus = PriceConsensus.fromPartial(
        object.PriceConsensus
      );
    } else {
      message.PriceConsensus = undefined;
    }
...
const baseQueryAllPriceConsensusRequest: object = {};

export const QueryAllPriceConsensusRequest = {
  encode(
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllPriceConsensusRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllPriceConsensusRequest,
    } as QueryAllPriceConsensusRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryAllPriceConsensusRequest {
    const message = {
      ...baseQueryAllPriceConsensusRequest,
    } as QueryAllPriceConsensusRequest;
    if (object.pagination !== undefined && object.pagination !== null) {
  ...
  toJSON(message: QueryAllPriceConsensusRequest): unknown {
    const obj: any = {};
    message.pagination !== undefined &&
      (obj.pagination = message.pagination
        ? PageRequest.toJSON(message.pagination)
  ...
  fromPartial(
    object: DeepPartial<QueryAllPriceConsensusRequest>
  ): QueryAllPriceConsensusRequest {
    const message = {
      ...baseQueryAllPriceConsensusRequest,
    } as QueryAllPriceConsensusRequest;
...
const baseQueryAllPriceConsensusResponse: object = {};

export const QueryAllPriceConsensusResponse = {
  encode(
    message: QueryAllPriceConsensusResponse,
    writer: Writer = Writer.create()
  ): Writer {
    for (const v of message.PriceConsensus) {
      PriceConsensus.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PageResponse.encode(
        message.pagination,
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllPriceConsensusResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllPriceConsensusResponse,
    } as QueryAllPriceConsensusResponse;
    message.PriceConsensus = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.PriceConsensus.push(
  ...
  fromJSON(object: any): QueryAllPriceConsensusResponse {
    const message = {
      ...baseQueryAllPriceConsensusResponse,
    } as QueryAllPriceConsensusResponse;
    message.PriceConsensus = [];
    if (object.PriceConsensus !== undefined && object.PriceConsensus !== null) {
      for (const e of object.PriceConsensus) {
        message.PriceConsensus.push(PriceConsensus.fromJSON(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromJSON(object.pagination);
  ...
  toJSON(message: QueryAllPriceConsensusResponse): unknown {
    const obj: any = {};
    if (message.PriceConsensus) {
      obj.PriceConsensus = message.PriceConsensus.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryAllPriceConsensusResponse>
  ): QueryAllPriceConsensusResponse {
    const message = {
      ...baseQueryAllPriceConsensusResponse,
    } as QueryAllPriceConsensusResponse;
    ...
    if (object.PriceConsensus !== undefined && object.PriceConsensus !== null) {
      for (const e of object.PriceConsensus) {
        message.PriceConsensus.push(PriceConsensus.fromPartial(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromPartial(object.pagination);
...
export interface Query {
  ...
  PriceConsensus(
    request: QueryGetPriceConsensusRequest
  ): Promise<QueryGetPriceConsensusResponse>;
  /** Queries a list of PriceConsensus items. */
  PriceConsensusAll(
    request: QueryAllPriceConsensusRequest
  ): Promise<QueryAllPriceConsensusResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  PriceConsensus(
    ...
    const data = QueryGetPriceConsensusRequest.encode(request).finish();
    const promise = this.rpc.request(
      "pricechain.rd_net.registry.Query",
      "PriceConsensus",
      data
    ...
    return promise.then((data) =>
      QueryGetPriceConsensusResponse.decode(new Reader(data))
    );
  }
  ...
  PriceConsensusAll(
    ...
    const data = QueryAllPriceConsensusRequest.encode(request).finish();
    const promise = this.rpc.request(
      "pricechain.rd_net.registry.Query",
      "PriceConsensusAll",
      data
    ...
    return promise.then((data) =>
      QueryAllPriceConsensusResponse.decode(new Reader(data))
    );
  }
}
