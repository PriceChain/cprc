...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/PriceChain/rd_net/registry/params
   */
   ...
   * @request GET:/PriceChain/rd_net/registry/registry
   */
  queryRegistryAll = (
    query?: {
    ...
    this.request<RegistryQueryAllRegistryResponse, RpcStatus>({
      path: `/PriceChain/rd_net/registry/registry`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/PriceChain/rd_net/registry/registry/{id}
   */
